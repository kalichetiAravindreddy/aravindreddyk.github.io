  ...
  link.addEventListener('click', closeMobileMenu);
    ...
    (function(){
      ...
      function tick(){
        ...
        if(forward){ i++; if(i>str.length){ forward=false; setTimeout(tick,900); return; }} else { i--; if(i<0){ forward=true; p=(p+1)%phrases.length; }}
        setTimeout(tick,80);
      }
      tick();
    })();
